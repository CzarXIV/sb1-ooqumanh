      ...
      <div className="pt-32 pb-16 bg-gray-100">
        <div className="container-custom">
          <AnimatedSection className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg">
              Get in touch with our team for inquiries, appointments, or
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            <AnimatedSection>
              <div className="mb-12">
                ...
                <p className="mb-6">
                  Schedule an appointment to explore our latest pieces and meet
                  with our styling consultants.
                </p>
                <div className="space-y-2 text-gray-600">
                  <p>Dutse Alhaji</p>
                  <p>Abuja, Nigeria</p>
                  <p>+234 913 403 3460</p>
                </div>
              </div>
        ...
        <div className="container-custom">
          <AnimatedSection className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg mb-12">
              Stay connected with S&M Collection on social media for the latest
